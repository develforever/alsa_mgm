...
const models: TsoaRoute.Models = {
    ...
    "GetAllocationsSchema": {
        ...
        "properties": {
            ...
            "CreatedAt": {"dataType":"datetime","required":true},
            "UpdatedAt": {"dataType":"datetime","required":true},
            "assemblyLine": {"dataType":"nestedObjectLiteral","nestedProperties":{"product":{"dataType":"nestedObjectLiteral","nestedProperties":{"Active":{"dataType":"boolean","required":true},"Name":{"dataType":"string","required":true},"ProductID":{"dataType":"double","required":true}}},"Status":{"dataType":"double","required":true},"ProductID":{"dataType":"double","required":true},"Name":{"dataType":"string","required":true},"ALAssLineID":{"dataType":"double","required":true}}},
            "workstation": {"dataType":"nestedObjectLiteral","nestedProperties":{"AutoStart":{"dataType":"boolean","required":true},"PCName":{"dataType":"string"},"ShortName":{"dataType":"string","required":true},"Name":{"dataType":"string","required":true},"ALWStationID":{"dataType":"double","required":true}}},
        },
        "additionalProperties": true,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
